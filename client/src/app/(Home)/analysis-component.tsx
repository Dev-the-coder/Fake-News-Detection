...
const AnalysisComponent: React.FC<AnalysisComponentProps> = ({news}) => {
    ...
    return (
        <div className="relative flex flex-col items-end p-4 m-2 rounded-xl w-full gap-20">
            ...
            <div className="flex w-full">
                ...
                >
                    <div
                        className={`mb-2 text-right font-extrabold ${isGenuine ? "text-green-500" : "text-red-500"
                            }`}
                    >
                        {news.verdict}
                    </div>
                    <div
                        ...
                        dangerouslySetInnerHTML={{
                            __html: formatTextToHTML(news.analysis),
                        }}
                    />
                </div>
                <div
                    className={`ml-1 flex items-center justify-center w-12 h-12 text-white rounded-full font-bold cursor-pointer  ${isGenuine ? "bg-green-500" : "bg-red-500" }`}
